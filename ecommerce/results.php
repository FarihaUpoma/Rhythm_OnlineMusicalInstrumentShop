		...
		<?php
			...
			if(isset($_GET['add_cart']))
	        {
	            ...
	            else
	            {
	                ...
	                echo "<script>window.open('results.php?user_query=$search_query&search=$search','_self')</script>";
			                ...
			                while($row_pro=mysqli_fetch_array($run_pro))
			                {
			                    ...
			                    echo "
			                        ...
			                        <div id='single_product'>
			                            ...
			                            <a href='results.php?user_query=$search_query&search=$search&add_cart=$pro_id'>  <button style='float:right'>Add to Cart </button></a>
